...
# train_agent.train(num_timesteps=TOTAL_TIMESTEPS, start_timesteps=START_STEPS)
...
# # SAC (TUNED) AGENT
# env = gym.make("Ant-v4", render_mode="rgb_array")
# train_agent = sac.SACAgent(env, reward_scale=1)
# train_agent.train(num_timesteps=TOTAL_TIMESTEPS, start_timesteps=START_STEPS)
...
# timestep_list_ppo, reward_list_ppo = train_agent.efficient_train(num_iterations=TOTAL_TIMESTEPS)
...
# timestep_list_dpo, reward_list_dpo = train_agent.efficient_train(num_iterations=TOTAL_TIMESTEPS)
